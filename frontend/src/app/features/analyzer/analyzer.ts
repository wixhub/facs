import { Component, ElementRef, OnInit, ViewChild, inject, signal, OnDestroy } from '@angular/core';
...
export class Analyzer implements OnInit, OnDestroy {
